...
def lambda1_handler(event, context):
    ...
    send_command_to_master(masterInstanceId,\
        ...
        ssm_client)
    send_command_to_master(masterInstanceId,\
        "hadoop fs -put /home/hadoop/"+event['Configurations']['source_data']["filename"],\
        ssm_client)
    ...
    cost = (exe_time/3600*event['Configurations']['bill']['EC2_price']*event['Configurations']['instance_num'])\
        +(event['Configurations']['bill']['VPC_price']*exe_time/3600)\
        +(exe_time/3600*event['Configurations']['bill']['EMR_price']*event['Configurations']['instance_num'])\
